...
public class CreateFilesBasedOnState {
  ...
  public static void main(String[] args) {
    ...
    Path inStateFile =
      Paths.get("//Users/davidstroud//Java_Templates//CustomerStates//InStateCusts.txt");
    Path outOfStateFile =
      Paths.get("/Users/davidstroud/Java_Templates/CustomerStates//OutOfStateCusts.txt");
...
public static void createEmptyFile(Path file, String s)
{
  ...
  try
  {
      ...
      for(int cout = 0; count < NUMRECS; ++count)
