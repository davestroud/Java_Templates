...
public class JTicTacToe2 extends JFrame implements ActionListener
{
   ...
   public void paint(Graphics gr)
   {
    ...
    public static void chooseSpot(JButton[][] gameGrid)
    {
      ...
      if(!placementMade)
         if(gameGrid[0][0].getText().equals(OString) &&
          gameGrid[1][1].getText().equals(OString) &&
          gameGrid[2][2].getText().equals(BLANK))
         {
          ...
          if(gameGrid[0][0].getText().equals(OString) &&
            gameGrid[2][2].getText().equals(OString) &&
            gameGrid[1][1].getText().equals(BLANK))
          {
            ...
            if(gameGrid[2][2].getText().equals(OString) &&
              gameGrid[1][1].getText().equals(OString) &&
              gameGrid[0][0].getText().equals(BLANK))
            {
              ...
              if(gameGrid[0][2].getText().equals(OString) &&
                gameGrid[1][1].getText().equals(OString) &&
                gameGrid[2][0].getText().equals(BLANK))
              {
               ...
               if(gameGrid[0][2].getText().equals(OString) &&
                  gameGrid[2][0].getText().equals(OString) &&
                  gameGrid[1][1].getText().equals(BLANK))
               {
                 gameGrid[1][1].setText(OString);
                 placementMade = true;
                  ...
                  if(gameGrid[1][1].getText().equals(OString) &&
                     gameGrid[2][0].getText().equals(OString) &&
   ...
   {
     JTicTacToe2 frame = new JTicTacToe2();
